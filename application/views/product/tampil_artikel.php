          ...
          <div class="mdc-layout-grid__inner">
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
              <div class="mdc-card"><br>
                <center>
                <div><a class="mb-3 btn  btn-primary" href="<?= site_url('admin/tambah_artikel'); ?>">Tambah Data +</a></div>
                </center>
                    <?php
                    ...
                    $form->setView('admin/artikel');
                    $form->Search();
                    $form->setField(array('id','nama','isi'));
                    ...
                    $form->addInput('iklan','thumbnail');
                    $form->setImage('iklan','artikel');
                    $form->addInput('isi','plaintext');
                    $form->addInput('id','link');
                    $form->setLabel('id', 'update');
                    $form->setLink('id',base_url('admin/tambah_artikel'), 'id');
