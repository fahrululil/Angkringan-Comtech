          ...
          <div class="mdc-layout-grid__inner">
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
              <div class="mdc-card"><br>
                <center>
                <div><a class="mb-3 btn  btn-primary" href="<?= site_url('admin/tambah_cat'); ?>">Tambah Data +</a></div>
                </center>
                    <?php
                  ...
                  $form->setLink('id',base_url('admin/tambah_cat'), 'id');
