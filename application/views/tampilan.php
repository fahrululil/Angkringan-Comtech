...
<html lang="en">
  ...
  <div class="container">
	...
	<div class="col-md-4 col-sm-12">
	  <h1 class="logo"><i class="glyphicon glyphicon-tag"></i>Angkringan <span class="primary">Store</span></h1>
	  <p class="subtext">Aplikasi Toko Online</p>
	</div> <!-- col-md-4 -->
	...
	<div class="tab-content">
	  <div role="tabpanel" class="tab-pane active" id="featured-item">
	    <div class="tab-text">
	      ...
	      <a href="include/product.html" class="btn btn-default">Read More</a>
	    </div> <!-- tab-text -->
	    <img class="slide-img" src="include/img/iphone.png"/>
	  </div>
	  <div role="tabpanel" class="tab-pane" id="best-seller">
	    ...
	    <img class="slide-img" src="include/img/xbox.png"/>
	  </div>	    
	  <div role="tabpanel" class="tab-pane" id="discount">
	    ...
	    <img class="slide-img" src="include/img/ps4.png"/>
	  </div>
	  <div role="tabpanel" class="tab-pane" id="premium">
	    ...
	    <img class="slide-img" src="include/img/surface.png"/>
	  </div>
	  <div role="tabpanel" class="tab-pane" id="gift-idea">
	    ...
	    <img class="slide-img" src="include/img/tv.png"/>
	  </div>
	</div>
    </div> <!-- jumbotron -->
	...
	<div class="col-md-4">
	  <div class="thumbnail">
	    <img src="include/img/surface.png">
	    <div class="caption">
	...
	<div class="col-md-4">
	  <div class="thumbnail">
	    <img src="include/img/iphone.png">
	    <div class="caption">
	      <h4 class="pull-right">$599.99</h4>
